...
<body>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @if (auth()->user()->role === 'owner')
                            ...
                            <li>
                                <a  class="nav-link {{request()->is('manajemen-admin') ? 'text-success' : ''}}" href="/manajemen-admin">
                                    <i class="fas fa-user-cog"></i> <span>Manajemen Admin</span>
                                </a>
                            </li>

                            <li>
                                <a class="nav-link {{request()->is('manajemen-produk') ? 'text-success' : ''}}" href="/manajemen-produk">
                                    <i class="fas fa-box"></i> <span>Manajemen Produk</span>
                                </a>
                            </li>

                            <li>
                                <a class="nav-link {{request()->is('manajemen-artikel') ? 'text-success' : ''}}" href="/manajemen-artikel">
                                    <i class="fas fa-newspaper"></i> <span>Manajemen Artikel</span>
                                </a>
                            </li>

                            <li>
                                <a class="nav-link {{request()->is('manajemen-pelatihan') ? 'text-success' : ''}}" href="/manajemen-pelatihan">
                                    <i class="fas fa-chalkboard-teacher"></i> <span>Manajemen Pelatihan</span>
                                </a>
                            </li>

                            <li>
                                <a class="nav-link {{request()->is('manajemen-review') ? 'text-success' : ''}}" href="/manajemen-review">
                                    <i class="fas fa-star"></i> <span>Manajemen Review</span>
                                </a>
                            </li>

                            <li>
                                <a class="nav-link {{request()->is('manajemen-medsos') ? 'text-success' : ''}}" href="/manajemen-medsos">
                        ...
                        @if (auth()->user()->role === 'admin')
                            ...
                            <li>
                                <a class="nav-link {{request()->is('manajemen-produksi') ? 'text-success' : ''}}" href="/manajemen-produksi">
    ...
    <!-- JS Libraies -->
    <script src="{{ asset('assets-stisla/modules/jquery.sparkline.min.js') }}"></script>
